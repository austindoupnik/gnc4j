...
public class EngineAccount {
  ...
  @NoArgsConstructor
  public static class GNCAccountTypePointer extends PointerType {
    public static GNCAccountTypePointer malloc() {
      return new GNCAccountTypePointer(new IntByReference());
    }

    public GNCAccountTypePointer(final IntByReference value) {
      super(value.getPointer());
    }

    public GNCAccountType dereference() {
      final Pointer pointer = getPointer();
      if (pointer == Pointer.NULL) {
        return null;
      }
      final int value = pointer.getInt(0);
      for (final GNCAccountType accountType : GNCAccountType.values()) {
